...
const NETWORK_ONLY = [
  ...
  '/@vite',         // Vite HMR - NUNCA cachear
  '/src/',          // Módulos de desarrollo - NUNCA cachear
  'node_modules',   // Dependencias de desarrollo - NUNCA cachear
  '?t=',            // Vite cache-busting timestamps - NUNCA cachear
  '__vite_ping',    // Vite heartbeat
