...
export default function WhatsAppButton() {
    ...
    const bottomClass = isProfileRoute ? 'bottom-8' : 'bottom-24 md:bottom-8';
    ...
    return (
        <a
            ...
            className={`fixed ${bottomClass} right-6 z-40 group transition-all duration-300`}
        >
            {/* Pulse animation - solo en desktop */}
            {!isMobile && (
                <span className="absolute inset-0 rounded-full bg-bikitchen-gold animate-ping opacity-25" aria-hidden="true"></span>
            )}
