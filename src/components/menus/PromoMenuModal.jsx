...
import { X, ShoppingCart, Loader2, Check, Sparkles, Calendar } from 'lucide-react';
...
export default function PromoMenuModal({
    ...
    const [menu, setMenu] = useState([]); // raw dish objects { numero, proteina, vegetal, carbo }
    ...
    const loadMenu = async () => {
        ...
        try {
            ...
            if (menuData && Array.isArray(menuData)) {
                // Normalizar a objetos { numero, proteina, vegetal, carbo }
                ...
                console.log('[PromoMenuModal] Menú raw:', rawMenu);
                setMenu(rawMenu);
            } else {
            ...
            <div className="fixed inset-0 z-[60] flex items-center justify-center p-4">
                ...
                >
                    ...
                    <div className="p-6 overflow-y-auto flex-1 custom-scrollbar">
                                        ...
                                        return (
                                            ...
                                            >
                                                ...
                                                <div className="flex-1 min-w-0">
                                                    ...
                                                    <p className="text-sm text-gray-800 font-semibold leading-relaxed">{displayText}</p>
                                                </div>
                        ...
                        {/* Sustituciones — per-dish mode using the loaded weekly dishes */}
