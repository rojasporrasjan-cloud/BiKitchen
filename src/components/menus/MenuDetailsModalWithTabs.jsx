...
import { Utensils, ShoppingCart, Plus, Minus, MessageSquare, X, Coffee, Sun, Moon } from 'lucide-react';
            ...
            <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }} exit={{ opacity: 0 }} className="absolute inset-0 z-[100] bg-white/98 backdrop-blur-md flex items-center justify-center p-6 text-center">
              <div className="w-full max-w-sm space-y-8">
                <div className="space-y-3">
                  ...
                  <h3 className="text-3xl font-black text-slate-900">Preferencias</h3>
                  <p className="text-slate-400 text-[11px] uppercase tracking-[0.2em] font-bold">Personaliza tu experiencia</p>
                </div>
                <textarea
                  autoFocus
                  value={notes}
                  onChange={(e) => setNotes(e.target.value)}
                  placeholder="Ej: Solo pechuga, sin arroz en almuerzos, alergias..."
                ...
                <div className="flex gap-4">
                  ...
                  <button onClick={() => setShowNotes(false)} className="flex-1 py-5 bg-orange-500 text-white rounded-2xl font-black shadow-lg shadow-orange-500/20 uppercase tracking-widest text-[10px] active:scale-95 transition-transform">Guardar</button>
                </div>
              </div>
            </motion.div>
          )}
