...
export default function LazyImage({
    ...
    threshold = 0, // Cuánto del elemento debe ser visible para cargar
    rootMargin = '400px', // Cargar antes de que sea visible
    onLoad,
    onError,
    ...props
}) {
    ...
    useEffect(() => {
        // Si el elemento ya está en viewport al montar, cargar inmediatamente
