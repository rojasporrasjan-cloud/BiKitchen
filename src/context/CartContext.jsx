...
export function CartProvider({ children }) {
    ...
    useEffect(() => {
        const validateUserCoupon = async () => {
            if (appliedCoupon && appliedCoupon.singleUsePerUser) {
                if (currentUser) {
                    // Si el usuario se loguea, verificar si ya usó el cupón
                    ...
                    // Si el usuario hace logout, remover cupón si es de uso único por usuario
                    // (para evitar que otro usuario lo use accidentalmente)
                    setAppliedCoupon(null);
                }
            }
        };
