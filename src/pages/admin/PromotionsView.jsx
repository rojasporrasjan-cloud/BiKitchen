        ...
        <div className="p-6">
            ...
            <div className="flex bg-gray-100 p-1 rounded-xl self-start md:self-auto">
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-bold transition-all ${activeTab === 'packs'
                        ? 'bg-white shadow-sm text-gray-900'
                        : 'text-gray-500 hover:text-gray-700:text-gray-300'
                        }`}
                >
                ...
                <button
                    ...
                    className={`px-4 py-2 rounded-lg text-sm font-bold transition-all ${activeTab === 'individuales'
                        ? 'bg-white shadow-sm text-gray-900'
                        : 'text-gray-500 hover:text-gray-700:text-gray-300'
                        }`}
                >
