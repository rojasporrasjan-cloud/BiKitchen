...
import { Menu as MenuIcon, LogOut, X, LayoutDashboard, ShoppingBag, Users, ClipboardList, Truck, UtensilsCrossed, Gift, Tag, Search, Bell, Image, MessageCircle, FileText, Target, BadgePercent, Settings, Phone, CalendarDays } from 'lucide-react';
        ...
        <div className="flex h-screen bg-gray-50 font-sans text-gray-800 overflow-hidden print:h-auto print:overflow-visible">
            ...
            <div className="flex-1 flex flex-col h-full overflow-hidden relative print:h-auto print:overflow-visible">
                ...
                <header className="bg-gradient-to-r from-white via-gray-50 to-white shadow-sm p-3 md:p-4 flex justify-between items-center sticky top-0 z-10 border-b border-gray-200 backdrop-blur-sm shrink-0 print:hidden">
                    ...
                    <div className="hidden md:flex items-center gap-2 text-sm text-gray-400 font-medium px-4">
                        <Search size={16} className="opacity-40" />
                        <span className="opacity-40">BiKitchen Admin</span>
                    </div>

                    <div className="flex items-center gap-3 ml-auto">
                        {/* Notificaciones */}
                        <NavLink to="/admin/notifications" className="relative text-gray-500 hover:text-orange-500 transition-all p-2.5 hover:bg-orange-50 rounded-xl group">
